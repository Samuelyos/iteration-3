...
DROP TABLE IF EXISTS `courseLeader`;
...
LOCK TABLES `courseLeader` WRITE;
/*!40000 ALTER TABLE `courseLeader` DISABLE KEYS */;
/*!40000 ALTER TABLE `courseLeader` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-05-14 10:10:21
