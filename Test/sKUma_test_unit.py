...
class database_test(unittest.TestCase):
    ...
    def test_sql_tableCreator(self):
        ...
        self.db.mycursor.execute(
            "INSERT INTO `lectures` VALUES (1000,'TestLecture','AddressShort','2022-05-02','00:00','24:00',0),(1001,'TestLecture','AddressTest','2022-04-04','08:00','10:00',0);")
        ...
        self.db.mycursor.execute(
            "INSERT INTO admincheck (courseID, course, room, `date`, timefrom, timeuntil) VALUES (1000,'TestLecture','NewAddressShort','2022-05-02','00:00','24:00'),(1001,'TestLecture','NewAddressTest','2022-04-04','08:00','10:00');")
        ...
        self.db.mycursor.execute(
            f"UPDATE lectures SET room = '{dbrequest1000[2]}', date = '{dbrequest1000[3]}', timefrom = '{dbrequest1000[4]}', timeuntil = '{dbrequest1000[5]}' WHERE courseID = '{dbrequest1000[0]}'")
        self.db.mycursor.execute(
            f"UPDATE lectures SET room = '{dbrequest1001[2]}', date = '{dbrequest1001[3]}', timefrom = '{dbrequest1001[4]}', timeuntil = '{dbrequest1001[5]}' WHERE courseID = '{dbrequest1001[0]}'")
        self.db.mycursor.execute("SELECT * FROM lectures")
        dblecture = self.db.mycursor.fetchall()
